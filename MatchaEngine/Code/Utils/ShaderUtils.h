...
struct ShaderUtils
{
    ...
    [[nodiscard]] static std::vector<char> GetShaderErrorInfo(int32_t id, GLenum statusType)
    {
    ...
    [[nodiscard]] static GLenum ShaderDataTypeToGLDataType(ShaderDataType type)
    {
        switch (type)
        {
        case ShaderDataType::Float:
