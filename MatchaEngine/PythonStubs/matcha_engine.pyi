...
class Entity:
    ...
    # parent=None detaches to the scene root - the Pythonic spelling of passing a
    # default-constructed (invalid) Entity on the C++ side, since scripts have no way to
    # construct a blank Entity themselves.
    def set_parent(self, parent: Entity | None) -> None: ...
